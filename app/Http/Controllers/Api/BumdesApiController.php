...
class BumdesApiController extends Controller
{
    ...
    public function income(Request $request): JsonResponse
    {
        ...
        return response()->json(Income::latest('date')->get());
    }
    ...
    public function expenses(Request $request): JsonResponse
    {
        ...
        return response()->json(Expense::latest('date')->get());
    }
    ...
    public function loans(Request $request): JsonResponse
    {
        if ($request->isMethod('post')) {
            ...
            return response()->json(['ok' => true, 'data' => $loan], 201);
        }

        return response()->json(Loan::latest('borrow_date')->get());
    }

    /**
     * Return a borrowed item.
     */
    public function returnLoan(string $id): JsonResponse
    {
        ...
        return response()->json(['ok' => true, 'data' => $loan]);
    }
    ...
    {
        return response()->json(SavingsLoan::with('payments')->latest('loan_date')->get());
    }
    ...
    {
        return response()->json(BumdesType::all());
    }
    ...
    public function settings(Request $request): JsonResponse
    {
        if ($request->isMethod('post')) {
            ...
            return response()->json(['ok' => true, 'data' => $setting]);
        }
